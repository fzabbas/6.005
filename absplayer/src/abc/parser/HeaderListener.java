...
public interface HeaderListener extends ParseTreeListener {
  ...
  /**
   * Enter a parse tree produced by {@link HeaderParser#accidental}.
   * @param ctx the parse tree
   */
  void enterAccidental(HeaderParser.AccidentalContext ctx);
  /**
   * Exit a parse tree produced by {@link HeaderParser#accidental}.
   * @param ctx the parse tree
   */
  void exitAccidental(HeaderParser.AccidentalContext ctx);
  /**
